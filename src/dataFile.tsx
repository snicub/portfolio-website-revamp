  ...
  galleryCardInfo: [
...

    {
      ...
      plpImages: [
        ...
        { src: require("./Assets/plp/cooking/bowl.webp") },
        { src: require("./Assets/plp/cooking/bowl2.webp") },
        { src: require("./Assets/plp/cooking/bowl3.webp") },
      ],
    ...
    {
      img: require("./Assets/plp/fam/aurassert.webp"),
